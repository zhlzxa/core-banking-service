...
public record AccountResponse(long accountId, String currency, String balance) {

    static AccountResponse from(Account account) {
        return new AccountResponse(
                account.id(), account.currency(), MoneyFormatter.format(account.balance(), account.currency()));
    }
}
